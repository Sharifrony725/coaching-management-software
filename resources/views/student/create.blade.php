        ...
        <form action="" method="post" enctype="multipart/form-data" class="form-inline">
            @csrf
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="radio" name="student_type" value="theory" class="mr-2" checked/> Theory
                        <input type="radio" name="student_type" value="lab" class="mr-2 ml-2"/> Lab
                        <input type="radio" name="student_type" value="mock" class="mr-2 ml-2"/> Mock
                    </div>
