        ...
        <div class="row content">
            <div class="col-sm-12 pl-0 pr-0">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <h4 class="text-center font-weight-bold font-italic mt-3">Students Registration Form</h4>
                    </div>
                </div>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <select name="school_id" class="form-control col-sm-8" id="school" required>
                            <option value="" style="display: none">Select School</option>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" name="father_name" class="form-control col-sm-8" placeholder="Father's Name"
                            value="" id="fatherName" required>
                        <span class="text-danger"></span>
                    </div>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" name="father_profession" class="form-control col-sm-8" id="fatherProfession"
                            placeholder="Father's Profession" value="" required>
                        <span class="text-danger"></span>
                    </div>

                    <div class="form-group col-md-6 mb-3">
                        <label for="motherName" class="col-sm-4 col-form-label text-right">Mother's Name</label>
                        <input type="text" name="mother_name" class="form-control col-sm-8" placeholder="Mother's Name"
                            value="" id="motherName" required>
                        <span class="text-danger"></span>
                    </div>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" name="mother_profession" class="form-control col-sm-8" id="motherProfession"
                            placeholder="Mother's Profession" value="" required>
                        <span class="text-danger"></span>
                    </div>

                    <div class="form-group col-md-6 mb-3">
                        <label for="emailAddress" class="col-sm-4 col-form-label text-right">Email Address</label>
                        <input type="email" name="email_address" class="form-control col-sm-8" id="emailAddress"
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="date" name="date_of_admission" class="form-control col-sm-8"
                            id="dateOfAdmission" required>
                   ...
                   <div class="col-12">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <div class="form-check col-form-label mr-2">
                    ...
                    <div class="form-group col-12 mb-3 pl-2">
                        ...
                        <input type="text" name="address" class="form-control col-sm-10" id="address"
                            placeholder="Detail Address" value="" required />
                    </div>
