        ...
        <div class="row content">
            <div class="col-md-8 offset-md-2 pl-0 pr-0">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <h4 class="text-center font-weight-bold font-italic mt-3">Add Slider</h4>
                    </div>
                </div>
                ...
                <form action="{{ route('save.slide') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive p-1">
                        <table id="" class="table table-bordered dt-responsive nowrap text-center"
                            style="width: 100%;">
                            <tr>
                                <td><img src="{{ asset('admin/assets/images/camera.png') }}" alt=""
                                        id="slide_show" style="max-height: 244px"></td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="slide_image"
                                                id="slideImage" onchange="showImage(this, 'slide_show')" required>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                class="form-control @error('slide_description') is-invalid @enderror"
                                                name="slide_description" id="slideDescription"
                                                placeholder="Write slide description here"
                                                value="{{ old('slide_description') }}" required>
                                        </div>
                                    </div>
                                </td>
                            </tr>
